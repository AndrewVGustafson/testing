...
purged_words = words
while True:
    selection = input("Select an option:\n[W] Wrong letters, [L] Wrong Location Letters, [C] Correct Letters [G] Get Available Words [GG] Get Optimized Guess Words [E] End Game [N] New Game\n\n")
    match selection.lower():
        ...
        case 'gg':
            print("Please choose from one of the following words:")
            optimized_words = better_guesses(purged_words)
